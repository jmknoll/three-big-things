...
module.exports = (app) => {
    ...
    router.get("/me", verifyToken, userCtrl.me, userCtrl.updateAccountDetails, authCtrl.generateJWT, authCtrl.returnJWT);
    router.post("/users", userCtrl.create);
    router.post("/auth", authCtrl.authenticate, authCtrl.generateJWT, authCtrl.returnJWT);
    router.post("/oauth", authCtrl.oauth, authCtrl.generateJWT, authCtrl.returnJWT);
